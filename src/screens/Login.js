  ...
  return (
    <div style={{backgroundImage: 'url("https://images.pexels.com/photos/1565982/pexels-photo-1565982.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")', height: '100vh', backgroundSize: 'cover' }}>
      ...
      <div className='container'>
        <form className='w-auto m-auto mt-5 border bg-dark border-success rounded' onSubmit={handleSubmit}>
          <div className="m-3">
          ...
          <button type="submit" className="m-2 mx-2 btn btn-success">Submit</button>
